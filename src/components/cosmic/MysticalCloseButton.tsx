...
interface MysticalCloseButtonProps {
  onClick: () => void;
  className?: string;
  size?: 'sm' | 'md' | 'lg';
...
export const MysticalCloseButton = forwardRef<HTMLButtonElement, MysticalCloseButtonProps>(({
  onClick,
  className,
  size = 'md',
  variant = 'default',
...
MysticalCloseButton.displayName = 'MysticalCloseButton';
