  ...
  public: {
    Tables: {
      ...
      brand_embeddings: {
        ...
        Relationships: [
          {
            foreignKeyName: "brand_embeddings_brand_profile_id_fkey"
          ...
          {
            foreignKeyName: "brand_embeddings_brand_sample_id_fkey"
            columns: ["brand_sample_id"]
            isOneToOne: false
            referencedRelation: "brand_samples"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      brand_samples: {
        ...
        Relationships: [
          {
            foreignKeyName: "brand_samples_brand_profile_id_fkey"
            columns: ["brand_profile_id"]
            isOneToOne: false
            referencedRelation: "brand_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "brand_samples_source_asset_id_fkey"
      ...
      profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "profiles_default_brand_profile_id_fkey"
            columns: ["default_brand_profile_id"]
            isOneToOne: false
            referencedRelation: "brand_profiles"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      pgvector_available: { Args: never; Returns: boolean }
